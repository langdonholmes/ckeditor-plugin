...
export default class AbbreviationUI extends Plugin {
	...
	init() {
		...
		editor.ui.componentFactory.add( 'infobox', () => {
			const button = new ButtonView();

			button.label = 'Info Box';
			button.tooltip = true;
	...
	_createFormView() {
		...
		this.listenTo( formView, 'submit', () => {
			...
			const value = {
				abbr: formView.contInputView.fieldView.element.value,
				title: formView.titleInputView.fieldView.element.value
			};
			editor.execute( 'addContentBox', value );
	...
	_showUI() {
		...
		const commandValue = this.editor.commands.get( 'addContentBox' ).value;
