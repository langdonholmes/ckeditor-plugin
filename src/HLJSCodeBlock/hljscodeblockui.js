...
// console.log(window.CKEditor5.ui.dropdown)
...
export default class HLJSCodeBlockUI extends Plugin {
	...
	init() {
		...
		componentFactory.add('codeBlock', locale => {
			...
			const dropdownView = dropdownUtils.createDropdown(locale, SplitButtonView);
			...
			dropdownUtils.addListToDropdown(dropdownView, this._getLanguageListItemDefinitions(normalizedLanguageDefs));
